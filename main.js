...
object = quick_draw_data_set[randomNo];
console.log(object);

document.getElementById('object_drawn').innerHTML = "Sketch to be drawn - "+ object;
...
object = quick_draw_data_set[randomNo];
    sketch = object;
    document.getElementById('object_drawn').innerHTML = "Sketch to be drawn - "+ sketch;
}
...
function gotResults(error, results){
    if(error){
        ...
        document.getElementById("object").innerHTML = "Your sketch - "+ drawn_sketch;
